...
#--- OIL file
oilSourceList.append("CAN_TCM.oil")
...
cSourceList.append(projfile.ProjectFile("CAN_TCM.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("CAN_TCM/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("CAN_TCM/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("CAN_TCM/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("CAN_TCM/tpl_interrupts.c"))
