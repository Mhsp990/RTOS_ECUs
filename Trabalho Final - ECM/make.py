...
try:
	...
	print("\033[91mThe OS->BUILD->TRAMPOLINE_BASE_PATH key is not set correctly in the oil file CAN_EMC.oil.")
	print("Set the correct Trampoline installation path in the oil file and run goil again:\033[0m")
	print("goil -t=avr/arduino/nano --templates=../../../goil/templates/ CAN_EMC.oil")
	sys.exit(1)
...
#--- Add generated files
sourceList.append("CAN_EMC/tpl_app_config.c")

sourceList.append("CAN_EMC/tpl_dispatch_table.c")
sourceList.append("CAN_EMC/tpl_invoque.S")
sourceList.append("CAN_EMC/tpl_interrupts.c")
