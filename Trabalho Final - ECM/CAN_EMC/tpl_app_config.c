 ...
 * Automatically generated by goil on Mon Jun 12 17:25:43 2023
 * from root OIL file CAN_EMC.oil
 *
...
/* Task EngRotTask identifier */
#define EngRotTask_id 0
CONST(TaskType, AUTOMATIC) EngRotTask = EngRotTask_id;

/* Task ReceiveCANM1 identifier */
#define ReceiveCANM1_id 1
CONST(TaskType, AUTOMATIC) ReceiveCANM1 = ReceiveCANM1_id;

/* Task SendCANM2 identifier */
#define SendCANM2_id 2
CONST(TaskType, AUTOMATIC) SendCANM2 = SendCANM2_id;

/* Task CalculateVelocityCANM3 identifier */
#define CalculateVelocityCANM3_id 3
CONST(TaskType, AUTOMATIC) CalculateVelocityCANM3 = CalculateVelocityCANM3_id;
 ...
 */
/*-----------------------------------------------------------------------------
 * Task EngRotTask descriptor
 */
#define APP_Task_EngRotTask_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task EngRotTask function prototype
 */

FUNC(void, OS_APPL_CODE) EngRotTask_function(void);
#define APP_Task_EngRotTask_STOP_SEC_CODE
...
/*
 * Task EngRotTask stack
 *
 */
#define APP_Task_EngRotTask_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word EngRotTask_stack_zone[256/sizeof(tpl_stack_word)];
#define APP_Task_EngRotTask_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define EngRotTask_STACK { EngRotTask_stack_zone, 256 }

/*
 * Task EngRotTask context
 */
avr_context EngRotTask_int_context;
#define EngRotTask_CONTEXT &EngRotTask_int_context
...
/*
 * Static descriptor of task EngRotTask
 */
CONST(tpl_proc_static, OS_CONST) EngRotTask_task_stat_desc = {
  /* context                  */  EngRotTask_CONTEXT,
  /* stack                    */  EngRotTask_STACK,
  /* entry point (function)   */  EngRotTask_function,
  /* internal ressource       */  NULL,
  /* task id                  */  EngRotTask_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task EngRotTask
 */
VAR(tpl_proc, OS_VAR) EngRotTask_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
...
#include "tpl_memmap.h"
tpl_stack_word SendCANM2_stack_zone[256/sizeof(tpl_stack_word)];
...
#define SendCANM2_STACK { SendCANM2_stack_zone, 256 }
...
/*-----------------------------------------------------------------------------
 * Task CalculateVelocityCANM3 descriptor
 */
#define APP_Task_CalculateVelocityCANM3_START_SEC_CODE

#include "tpl_memmap.h"
/*
 * Task CalculateVelocityCANM3 function prototype
 */

FUNC(void, OS_APPL_CODE) CalculateVelocityCANM3_function(void);
#define APP_Task_CalculateVelocityCANM3_STOP_SEC_CODE
...
/*
 * Task CalculateVelocityCANM3 stack
 *
 */
#define APP_Task_CalculateVelocityCANM3_START_SEC_STACK
#include "tpl_memmap.h"
tpl_stack_word CalculateVelocityCANM3_stack_zone[256/sizeof(tpl_stack_word)];
#define APP_Task_CalculateVelocityCANM3_STOP_SEC_STACK
#include "tpl_memmap.h"

#define OS_START_SEC_VAR_UNSPECIFIED
#include "tpl_memmap.h"

#define CalculateVelocityCANM3_STACK { CalculateVelocityCANM3_stack_zone, 256 }

/*
 * Task CalculateVelocityCANM3 context
 */
avr_context CalculateVelocityCANM3_int_context;
#define CalculateVelocityCANM3_CONTEXT &CalculateVelocityCANM3_int_context
...
/*
 * Static descriptor of task CalculateVelocityCANM3
 */
CONST(tpl_proc_static, OS_CONST) CalculateVelocityCANM3_task_stat_desc = {
  /* context                  */  CalculateVelocityCANM3_CONTEXT,
  /* stack                    */  CalculateVelocityCANM3_STACK,
  /* entry point (function)   */  CalculateVelocityCANM3_function,
  /* internal ressource       */  NULL,
  /* task id                  */  CalculateVelocityCANM3_id,
#if WITH_OSAPPLICATION == YES
  /* OS application id        */  
#endif
...
#include "tpl_memmap.h"
/*
 * Dynamic descriptor of task CalculateVelocityCANM3
 */
VAR(tpl_proc, OS_VAR) CalculateVelocityCANM3_task_desc = {
  /* resources                      */  NULL,
#if WITH_OSAPPLICATION == YES
  /* if > 0 the process is trusted  */  0,    
#endif /* WITH_OSAPPLICATION */
 ...
 *
 * This alarm does the activation of task CalculateVelocityCANM3
 */
 ...
 *
 * This alarm does the activation of task EngRotTask
 */
