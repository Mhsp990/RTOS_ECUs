...
#--- OIL file
oilSourceList.append("CAN_EMC.oil")
...
cSourceList.append(projfile.ProjectFile("CAN_EMC.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("CAN_EMC/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("CAN_EMC/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("CAN_EMC/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("CAN_EMC/tpl_interrupts.c"))
