...
#--- OIL file
oilSourceList.append("CAN_ICM.oil")
...
cSourceList.append(projfile.ProjectFile("CAN_ICM.cpp"))

#--- Add generated files
cSourceList.append(projfile.ProjectFile("CAN_ICM/tpl_app_config.c"))

cSourceList.append(projfile.ProjectFile("CAN_ICM/tpl_dispatch_table.c"))
cSourceList.append(projfile.ProjectFile("CAN_ICM/tpl_invoque.S"))
cSourceList.append(projfile.ProjectFile("CAN_ICM/tpl_interrupts.c"))
